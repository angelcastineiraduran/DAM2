package com.example.pruebaborrar2.temasYEstilos
...
class CambiandoEstiloPredefinido {
    @Composable
    private fun Greeting(txtBtn: String) {
        ...
        ElevatedButton(
            ...
            Text(
                ...
                // cambiamos el estilo predef y le ponemos mas negrita
    ...
    @Composable
    fun previewCambiandoEstiloPredefinido() {
        MyApp()
    }
